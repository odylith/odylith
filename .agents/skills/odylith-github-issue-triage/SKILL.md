...
Use when the operator gives a GitHub issue URL or number and wants Odylith to
fetch it, classify it, map it to Casebook/Radar/Registry truth, and draft the
public GitHub response.
