...
- Keep `Status` and `Type` to compact single-word tokens such as `Open`, `FixedPendingRelease`, `Product`, or `UX`; put longer rollout, classification, and evidence notes in concrete evidence fields.
