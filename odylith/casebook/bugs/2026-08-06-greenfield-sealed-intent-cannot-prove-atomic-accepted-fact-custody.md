...
- Recovered Historical Learning (2026-09-10): Consolidation found an uncommitted 2026-08-20 P0 report in the superseded release checkout: an editorial instruction about retiring a brainstorm label was promoted into product actions, state transitions, responsibilities and governed surfaces despite exact citations and a fast verified transaction. Exact source-byte custody does not establish semantic entailment. Preserve this failure class under the current canonical-meaning owner; do not restore the old multi-candidate semantic-packet experiment, its historical bug identifier, lexical discard classifiers or downstream filtering. Current author and review roles must distinguish instructions about evidence from product behavior, with independent whole-package evidence before any closure claim. The historical tracked delta and untracked artifacts are retained in /Users/freedom/.codex/odylith-ide-reconciliation.mb9MLV/release-e2f60d51-uncommitted.patch and release-e2f60d51-untracked.tar. This records prior failure evidence, not a new passing result or a newly observed defect in the current candidate.
