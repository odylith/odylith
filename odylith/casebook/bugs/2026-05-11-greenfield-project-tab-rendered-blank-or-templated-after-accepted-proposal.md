...
- Failure Signature: Project tab showed placeholder-repo blank state, orienting work, templated Product Story/source-map layout, or first-path scenario prose squeezed into a narrow label column despite accepted greenfield project artifacts existing.
...
- Regression Tests Added: Updated greenfield apply Project tab regression, Project Intelligence greenfield rendering regression, Product Story source-backed rendering regression, scenario prose layout regression, tooling dashboard accepted-project refresh regression, and owned-surface tooling_shell refresh regression.
