...
- Mechanism-Freeze Checkpoint (2026-08-26, one holistic author): The replacement two-author primary/failover path was itself falsified when provider saturation produced four disclosed standard failures and the peer recovered none. The active path is now `holistic_tagged_entity_effect_source_meaning`: one whole source-grounded author call, deterministic validation and projection only, with no critic, peer, selector, merge, retry, repair, or automatic deep call. The losing authoring/selection stack was deleted rather than retained as fallback. A fresh disclosed 24-case cohort produced the exact expected terminal for every case (17 commits and 7 focused clarifications), used exactly 24 model calls, and had zero restarts, rescues, or deep executions; mean completion was 24.283 seconds and the 32.848-second worst case satisfied the strict standard `<60s` law. Its plan, manifest, mechanism, and implementation hashes are `88e4429f279a2f8948f680f88eea4ce87594ad383e089c0aa2adf69bbfad81a2`, `35492242eb6542f5266f3572df5d716f66174f4196f6d5c2f1e5400e9b81b410`, `holistic_tagged_entity_effect_source_meaning`, and `3297ab18474e4db67a872bfe3e66ec17b03d6976defddd4113bfc049ec41bdb0`. The active Greenfield runtime/install suite also passes 463 tests. This is a frozen development baseline, not release evidence: independent semantic/package review, deterministic-law evidence on an immutable revision, Codex/Claude parity, lower-capability safety, clean-install/browser proof, and the protected final holdout remain required. Do not replace or enlarge this mechanism unless current disclosed evidence shows a semantic P0/P1, a hard 60/90/120 violation, or a security/transaction defect; a passing result alone is not grounds for a new mechanism.
