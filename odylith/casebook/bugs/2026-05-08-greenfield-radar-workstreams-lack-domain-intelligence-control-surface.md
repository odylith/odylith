...
- Detected By: Operator transcript for an external-domain greenfield flow plus direct review of generated workstream quality.
...
- Trigger Path: odylith greenfield propose/create --prompt '<greenfield domain fixture>' --release 0.0.1 --confirm, then inspect B-002/B-003 Radar workstream specs and subsequent technical-plan kickoff.
