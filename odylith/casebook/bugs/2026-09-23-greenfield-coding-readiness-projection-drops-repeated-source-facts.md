...
- Prevention: Keep exact source-fact copy separate from normalized or deduplicated presentation helpers and test duplicate, Unicode, whitespace, and empty-input cases
