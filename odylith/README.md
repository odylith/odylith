...
The active Codex or Claude host reasons axis-first from the exact evidence, assembles the
temporary typed graph, and independently challenges it for unsupported additions, polarity,
ownership, endpoint, and component-boundary errors. A citation proves custody, not
entailment. Odylith treats that packet as an
