...
3. Treat the CLI proposal as apply-ready product output. Odylith builds the
   canonical proposal object, validates it against the apply contract, runs the
   greenfield Tribunal, and renders the human proposal from that same object.
