...
- Empty/thin project prompts route to `odylith greenfield propose --repo-root . --prompt "<request>"`; render backlog, waves, release plan, Registry, Atlas, assumptions, risks, validation; keep observed source separate from user intent; write only after confirmation.
