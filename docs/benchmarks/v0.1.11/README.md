...
- Diagnostic: `9dcae95d5bb62c75`
  - generated: `2026-04-25T11:20:25Z`
  - status: `provisional_pass`
  - comparison: internal packet and prompt diagnostic lane

## Rendered Artifacts

- [Live Benchmark Snapshot](LIVE_BENCHMARK_SNAPSHOT.md)
- [Internal Diagnostic Benchmark Snapshot](GROUNDING_BENCHMARK_SNAPSHOT.md)
- [Benchmark Tables](BENCHMARK_TABLES.md)
- [Proof Graphs](proof/)
- [Diagnostic Graphs](diagnostic/)
...
- canonical live and diagnostic report JSON
