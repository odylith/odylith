...
def test_authored_v0_1_10_release_note_drives_upgrade_popup_copy(tmp_path: Path, monkeypatch) -> None:  # noqa: ANN001
    repo_root = tmp_path / "upgrade-v0-1-10"
    repo_root.mkdir()
    _seed_consumer_repo(
        repo_root,
        focus_path="src/billing",
    ...
    write_upgrade_spotlight(
        ...
        to_version="0.1.10",
        release_tag="v0.1.10",
        release_url="https://example.com/releases/v0.1.10",
        release_published_at="2026-04-08T01:30:00Z",
    ...
    shutil.copy2(
        REPO_ROOT / "odylith" / "runtime" / "source" / "release-notes" / "v0.1.10.md",
        notes_root / "v0.1.10.md",
    )
    _render_shell(repo_root, monkeypatch)
