...
def test_bug_capture_accepts_github_linkage_optional_fields_in_payload(tmp_path: Path) -> None:
    result = bug_authoring.capture_bug_from_payload(
        ...
        payload={
            ...
            "data_risk": "Low data risk; issue closeout updates governed GitHub/Casebook memory only.",
            "security_compliance": "Security/compliance posture: no credentials change; policy risk is stale public issue truth.",
