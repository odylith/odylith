...
def test_build_governance_summary_includes_component_registry_counts(tmp_path: Path) -> None:
    ...
    (ideas_dir / "2026-03-04-compass-fixture.md").write_text(
        (
            ...
            "supersedes:\n\n"
            "superseded_by:\n\n"
            "## Problem\nGovernance intelligence fixtures need meaningful Radar detail.\n\n"
            "## Customer\nMaintainers validating component inference from fixture workstreams.\n\n"
            "## Opportunity\nMeaningful fixture prose keeps intelligence checks aligned with validation.\n\n"
            "## Proposed Solution\nBody.\n\n"
            "## Scope\nBody.\n\n"
            "## Non-Goals\nBody.\n\n"
            "## Risks\nBody.\n\n"
            "## Dependencies\nBody.\n\n"
            "## Success Metrics\n- Governance intelligence fixtures validate cleanly.\n- Component inference remains deterministic.\n\n"
            "## Validation\nBody.\n\n"
            "## Rollout\nBody.\n\n"
            "## Why Now\nBody.\n\n"
            "## Product View\nGovernance intelligence should reject weak ideas without breaking valid fixtures.\n\n"
            "## Impacted Components\nBody.\n\n"
            "## Interface Changes\nBody.\n\n"
