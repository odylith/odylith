...
def test_tribunal_case_facts_keep_case_refs_precise() -> None:
    ...
    assert refs_by_headline["A local Casebook record is linked to this path: CB-121."] == {("bug", "CB-121")}
    assert refs_by_headline["A local Casebook record is linked to this path: CB-122."] == {("bug", "CB-122")}
