...
def test_greenfield_create_cli_uses_transaction_authority_not_mutable_intent_files(
    ...
    markdown_path = tmp_path / str(authority["markdown_source_path"])
    sidecar_path = tmp_path / str(authority["structured_intent_path"])
    ...
    def fake_compiled_write(**kwargs: Any) -> dict[str, Any]:
        ...
        return greenfield_compiled_write.compiled_greenfield_commit_result(
