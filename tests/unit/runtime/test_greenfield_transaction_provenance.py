...
def test_sealed_commit_loader_requires_exact_v13_authority_protocol(
    tmp_path: Path,
    mutation: str,
) -> None:
    transaction = _transaction(tmp_path)
...
def test_create_contract_accepts_only_v13_intent_authority() -> None:
    assert PRODUCT_CREATE_TRANSACTION_ACCEPTED_INTENT_AUTHORITY_VERSION == "odylith.product-intent-authority.v13"
