...
def test_public_tree_contains_no_legacy_contract_leaks() -> None:
    ...
    for base in (ROOT / "src", ROOT / "docs", ROOT / "odylith"):
        for path in base.rglob("*"):
            ...
            if any(relative.startswith(prefix) for prefix in SKIP_RUNTIME_HISTORY_PREFIXES):
                continue
            try:
...
def test_odylith_assist_closeout_contract_stays_explicit_across_shared_and_bundled_guidance() -> None:
    paths = (
        ...
        ROOT / "odylith" / "skills" / "delivery-governance-surface-ops" / "SKILL.md",
        ROOT / "odylith" / "skills" / "odylith-context-engine-operations" / "SKILL.md",
        ROOT / "odylith" / "skills" / "session-context" / "SKILL.md",
        ROOT / "odylith" / "skills" / "subagent-orchestrator" / "SKILL.md",
        ROOT / "odylith" / "skills" / "subagent-router" / "SKILL.md",
        ...
        ROOT / "src" / "odylith" / "bundle" / "assets" / "odylith" / "skills" / "delivery-governance-surface-ops" / "SKILL.md",
        ROOT / "src" / "odylith" / "bundle" / "assets" / "odylith" / "skills" / "odylith-context-engine-operations" / "SKILL.md",
        ROOT / "src" / "odylith" / "bundle" / "assets" / "odylith" / "skills" / "session-context" / "SKILL.md",
        ROOT / "src" / "odylith" / "bundle" / "assets" / "odylith" / "skills" / "subagent-orchestrator" / "SKILL.md",
        ROOT / "src" / "odylith" / "bundle" / "assets" / "odylith" / "skills" / "subagent-router" / "SKILL.md",
    )
    for path in paths:
