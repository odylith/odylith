    ...
    bundle = {
        "ambient_signals": {
            ...
            "risks": {
                "eligible": True,
                "render_hint": "explicit_label",
                "plain_text": "Odylith Risks: keep the Odylith note in frame for CB-121 now.",
                "markdown_text": "**Odylith Risks:** keep the Odylith note in frame for CB-121 now.",
                "semantic_signature": ["visible", "odylith", "moment", "cb-121"],
            },
            "history": {
                "eligible": True,
                "render_hint": "explicit_label",
                "plain_text": "Odylith History: keep the Odylith note in frame for CB-121 now.",
                "markdown_text": "**Odylith History:** keep the Odylith note in frame for CB-121 now.",
                "semantic_signature": ["visible", "odylith", "moment", "cb-121"],
            },
        },
        "intervention_bundle": {
