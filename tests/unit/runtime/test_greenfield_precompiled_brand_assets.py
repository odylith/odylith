...
def test_commit_product_create_transaction_rejects_missing_precompiled_brand_assets_before_write(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    def forbidden(*_args: Any, **_kwargs: Any) -> None:
        raise AssertionError("missing brand asset writes must fail before rollback guard or compiled writes")
...
def test_commit_product_create_transaction_does_not_seed_brand_assets_after_confirm(
    ...
    monkeypatch.setattr(greenfield_create_commit.brand_assets, "ensure_brand_assets", forbidden)
