...
def test_write_effective_claude_project_settings_writes_byte_stable_json(tmp_path: Path) -> None:
    ...
    for required in (
        ...
        "Bash(./.odylith/bin/odylith greenfield semantic-intent-schema:*)",
        "Bash(./.odylith/bin/odylith greenfield semantic-intent-request:*)",
        "Bash(./.odylith/bin/odylith greenfield propose:*)",
