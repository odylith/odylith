...
def _write_install_script(*, output_path: Path, tag: str, repo: str, odylith_wheel: str) -> None:
    ...
    script_lines = [
        ...
        *validate_release_script,
        ...
        "  fi",
        '  ODYLITH_INSTALL_PREVIOUS_ACTIVE_VERSION="$previous_active_version" ODYLITH_INSTALL_COMPACT=1 ODYLITH_BOOTSTRAP_RUNTIME_PRESTAGED=1 "$version_root/bin/python" -m odylith.cli install --repo-root "$repo_root" --version "$release_version"',
        "fi",
