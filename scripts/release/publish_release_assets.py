...
def _write_install_script(*, output_path: Path, tag: str, repo: str, odylith_wheel: str) -> None:
    ...
    script_lines = [
        ...
        *PYTHON_ENV_SCRUB_LINES,
        ...
        "    guidance) ;;",
        "    git)",
        "      say \"No root AGENTS.md, CLAUDE.md, or .claude/CLAUDE.md was found above this directory. Odylith will create the root guidance entrypoints at the detected Git root and sync the Claude project assets there.\"",
        "      ;;",
        "    folder)",
        "      say \"No enclosing AGENTS.md, CLAUDE.md, .claude/CLAUDE.md, or .git was found. Odylith will treat the current folder as the repo root and create root AGENTS.md, root CLAUDE.md, and project .claude assets here.\"",
