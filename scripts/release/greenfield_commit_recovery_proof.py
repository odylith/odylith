...
_DEFAULT_SEMANTIC_FIXTURE = Path(__file__).resolve().parent / "fixtures" / "greenfield-semantic-smoke.v11.json"
...
def load_semantic_recovery_case(
    ...
    if packet.get("version") != "odylith.greenfield.semantic-intent-packet.v11":
...
def _require_case_evidence_bound_to_transaction(
    *,
    ...
    expected = {
        "version": "odylith.product-intent-authority.v17",
        "origin": "verified_semantic_intent_packet",
        "source_format": "semantic_intent_packet",
        "evidence_sha256": str(case.packet.get("evidence_sha256") or ""),
        "semantic_intent_packet_version": "odylith.greenfield.semantic-intent-packet.v11",
