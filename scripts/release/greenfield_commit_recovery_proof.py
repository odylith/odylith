...
_DEFAULT_SEMANTIC_FIXTURE = Path(__file__).resolve().parent / "fixtures" / "greenfield-semantic-smoke.v10.json"
...
def load_semantic_recovery_case(
    ...
    if packet.get("version") != "odylith.greenfield.semantic-intent-packet.v10":
