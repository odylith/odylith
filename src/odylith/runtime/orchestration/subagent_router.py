...
_TASK_CLASS_POLICIES: dict[str, TaskClassPolicy] = {
    ...
    "bounded_feature": TaskClassPolicy(
        ...
        minimum_profile=RouterProfile.CODEX_MEDIUM,
        default_agent_role="worker",
        rationale="New bounded write behavior defaults to the write-high tier, with frontier profiles reserved for riskier or more architecture-heavy cases.",
    ),
    "analysis_review": TaskClassPolicy(
        ...
        rationale="Bounded read-only analysis defaults to the analysis-high explorer tier and promotes only when ambiguity or risk demand more depth.",
    ),
    "critical_change": TaskClassPolicy(
        ...
        default_agent_role="worker",
        rationale="Critical or hard-to-reverse changes default to frontier-high; `xhigh` stays gated behind explicit risk triggers.",
    ),
