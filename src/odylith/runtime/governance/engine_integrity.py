...
ENGINE_AREAS: tuple[EngineArea, ...] = (
    ...
    EngineArea(
        "Domain Intelligence",
        ("Domain Intelligence",),
        ("odylith greenfield propose", "odylith greenfield create", "odylith greenfield apply"),
        "greenfield/project-shape confirmation plus validated apply-ready proposals",
    ),
    EngineArea(
