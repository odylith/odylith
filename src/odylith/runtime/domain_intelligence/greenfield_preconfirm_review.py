"""Typed review findings for greenfield pre-confirm custody."""
...
PRECONFIRM_REVIEW_REPORT_VERSION = "odylith.greenfield.preconfirm.review_report.v1"
...
class GreenfieldReviewReport:
    """Typed pre-confirm review report used as the repair-routing contract."""
...
def review_finding(
    *,
    ...
    return GreenfieldReviewFinding(
        code=normalize_token(code) or "preconfirm_contract",
        surface=normalize_string(surface) or "preconfirm",
        ...
        owner=normalize_token(owner) or "preconfirm_engine",
        source=normalize_token(source) or "preconfirm",
...
def review_report_from_findings(
    ...
    return GreenfieldReviewReport(
        version=PRECONFIRM_REVIEW_REPORT_VERSION,
...
__all__ = [
    "GreenfieldReviewFinding",
    "GreenfieldReviewReport",
    "PRECONFIRM_REVIEW_REPORT_VERSION",
