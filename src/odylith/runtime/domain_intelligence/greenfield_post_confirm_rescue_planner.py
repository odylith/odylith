    ...
    *,
    ...
    for operation in operations:
        ...
        updated["proof_obligation_delta"] = {
            ...
            "added_obligations": [],
            "removed_obligations": [],
            "unchanged_obligations": ["final post-confirm quality gate still validates the rerendered governed records"],
        }
...
def _source_anchored_decision_ledger(operation: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "rationale": (
            "the typed post-confirm finding identified an exact SemanticModelIR target, and the current proposal "
...
def _structured_patch_review_report(
    ...
    return {
        "version": "odylith.greenfield.post_confirm.review_report.v1",
