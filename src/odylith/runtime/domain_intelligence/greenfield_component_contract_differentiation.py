...
_AXES: tuple[_Axis, ...] = (
    _Axis(
        ...
        triggers=("assignment", "assign", "permission", "access", "eligibility", "role", "routing", "conflict"),
        ...
        outside_boundary="form layout, scoring rubric, score calculation, immutable audit storage, comparison dashboard, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        key="form_scoring",
        triggers=("form", "scoring", "score", "template", "rubric", "criteria", "question"),
