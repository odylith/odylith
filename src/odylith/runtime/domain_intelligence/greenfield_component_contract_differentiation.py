...
_AXES: tuple[_Axis, ...] = (
    _Axis(
        ...
        local_proof=(
            ...
            "Changing reviewer assignment does not mutate criteria or protocol state.",
        ),
    ...
    _Axis(
        ...
        outside_boundary="criteria definition, reviewer assignment, review decisions, evidence extraction, synthesis conclusions, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        ...
        outside_boundary="criteria definition, reviewer assignment, permission grants, evidence extraction, scoring rubric ownership, synthesis conclusions, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        ...
        outside_boundary="criteria definition, reviewer assignment, screening inclusion decisions, score calculation, synthesis conclusions, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        key="decision_review",
        triggers=("decision", "approval", "approve", "package", "blocker", "note", "readiness", "final", "outcome"),
        ...
        outside_boundary="criteria definition, reviewer assignment, permission grants, revision intake, raw evidence extraction, scoring rubric ownership, immutable audit storage, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        ...
        outside_boundary="scoring ownership refuses reviewer assignment, permission grants, assignment routing, immutable audit storage, retention enforcement, dashboard ranking, and sibling product responsibilities",
        local_proof=(
    ...
    _Axis(
        ...
        outside_boundary="source ingestion, criteria definition, reviewer assignment, raw extraction ownership, immutable audit storage, and sibling product responsibilities",
        local_proof=(
