"""Internal release proof probe for greenfield pre-confirm rescue wiring."""
...
RESCUE_PROBE_TOKEN = "typed-pre-confirm-rescue-v1"
RESCUE_PROBE_CODE = "preconfirm_rescue_probe"
RESCUE_PROBE_SOURCE = "release_rescue_probe"
RESCUE_PROBE_MARKER_KEY = "preconfirm_rescue_probe"
...
def rescue_probe_patch_values(finding: GreenfieldReviewFinding) -> Mapping[str, Any]:
    ...
    return {
        ...
        "decision_ledger_entry": {
            ...
            "rationale": "release matrix enabled the deterministic pre-confirm rescue probe",
