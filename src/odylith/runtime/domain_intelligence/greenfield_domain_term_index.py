...
def ordered_terms(
    ...
    *,
    ...
    return list(_ordered_terms_cached(_clean(value).casefold(), stop, minimum))


@lru_cache(maxsize=4096)
def _ordered_terms_cached(cleaned_text: str, stopwords: tuple[str, ...], minimum: int) -> tuple[str, ...]:
    result: list[str] = []
    seen: set[str] = set()
