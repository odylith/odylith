"""Accessors for typed greenfield pre-confirm repair context payloads."""
...
def repair_context_operations(repair_context: GreenfieldPreconfirmRepairContext | None) -> list[Mapping[str, Any]]:
