...
from odylith.runtime.context_engine.tooling_context_narrowing_guidance import build_narrowing_guidance
...
def build_routing_handoff(
    *,
    ...
    validation_bundle = routing_support.routing_validation_bundle(final_payload)
