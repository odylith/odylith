...
def _legacy_test_command(module_name: str) -> str:
    ...
    specific: dict[str, str] = {
        ...
        "render_compass_dashboard": "odylith compass update --repo-root .",
        "compass_dashboard_base": "odylith compass update --repo-root .",
        "compass_dashboard_runtime": "odylith compass update --repo-root .",
        "compass_dashboard_shell": "odylith compass update --repo-root .",
        "compass_standup_brief_narrator": "odylith compass update --repo-root .",
