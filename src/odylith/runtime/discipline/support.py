...
HOST_LANE_SUPPORT_CONTRACT = "odylith_discipline_host_lane_support.v1"
...
def host_capabilities(host_family: str) -> dict[str, Any]:
    ...
    common = {
        ...
        "host_model_credit_policy": "discipline_checks_never_call_host_models",
    }
    if host == "codex":
        return {
            **common,
...
def host_lane_support(*, host_family: str, lane: str) -> dict[str, Any]:
    ...
    return {
        ...
        "semantic_contract_supported": bool(host["known_host"] and host["semantic_discipline_contract"] and lane_profile["known_lane"]),
        "local_discipline_check": bool(host["local_discipline_check"]),
