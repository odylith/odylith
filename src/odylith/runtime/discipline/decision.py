...
from odylith.runtime.discipline import budget
from odylith.runtime.discipline.affordance import rank_affordances
from odylith.runtime.discipline.benchmark import benchmark_tags_for_decision
from odylith.runtime.discipline.contract import (
    DISCIPLINE_CONTRACT,
    HARD_LAW_DECISIONS,
    HARD_LAWS,
    compact_mapping,
)
from odylith.runtime.discipline.laws import evaluate_hard_laws, violated_laws
from odylith.runtime.discipline.learning import learning_signal
from odylith.runtime.discipline.memory import practice_event_from_decision, safe_practice_strings
from odylith.runtime.discipline.pressure import observe_pressure
from odylith.runtime.discipline.proof import proof_obligation_for_decision
from odylith.runtime.discipline.stance import infer_stance_vector
from odylith.runtime.discipline.support import host_lane_support
from odylith.runtime.discipline.voice import intervention_candidate_for_decision
...
def _decision_id(*, intent: str, host_family: str, lane: str, evidence: Mapping[str, Any]) -> str:
    ...
    return f"discipline:{host_family}:{lane}:{digest}"
...
def evaluate_discipline_move(
    *,
    ...
    payload["learning_signal"] = learning_signal(
        ...
        pressure=pressure,
        hard_law_results=hard_laws,
        benchmark_tags=[*payload["known_archetype_matches"], "discipline"],
    )
