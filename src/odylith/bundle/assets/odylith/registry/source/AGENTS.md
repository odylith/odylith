...
- In consumer repos diagnosing Odylith product issues, Registry source is
  read-only: prepare component-ready handoff evidence instead of editing local
  Odylith Registry truth.
