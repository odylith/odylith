...
def managed_block(*, repo_role: str = "consumer_repo") -> str:
    ...
    lines = [
        ...
        "- Empty/thin prompts route to `odylith greenfield propose --repo-root . --prompt \"<request>\"` to review the apply-ready proposal; confirm with `odylith greenfield create --repo-root . --prompt \"<request>\" --release 0.0.1 --confirm` so Odylith owns construction, validation, Tribunal, writes, refresh, and handoff. Do not hand-author proposal JSON.",
