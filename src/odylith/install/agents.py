...
def managed_block(*, repo_role: str = "consumer_repo") -> str:
    ...
    lines = [
        ...
        "- Empty/thin prompts route to `odylith greenfield propose --repo-root . --prompt \"<request>\"` for a compact product-first interpretation, direction choices, non-goals, first release ambition, and proof gates; confirmed writes use `odylith greenfield create --repo-root . --prompt \"<request>\" --release 0.0.1 --confirm` after validation and the Tribunal write gate. Do not hand-author proposal JSON or code before the product gates are accepted.",
