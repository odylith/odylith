...
def managed_block(*, repo_role: str = "consumer_repo") -> str:
    ...
    lines = [
        ...
        "- Empty/thin prompts route to `odylith greenfield propose --repo-root . --prompt \"<request>\"` for an apply-ready, project-first proposal with direction options and coding-readiness gates; confirm with `odylith greenfield create --repo-root . --prompt \"<request>\" --release 0.0.1 --confirm`. Do not hand-author proposal JSON or code before the gates are accepted.",
